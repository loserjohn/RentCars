<template>
	<view class="tui-numberbox-class tui-numberbox">
		<view class="tui-numbox-icon tui-icon-reduce " :class="[disabled || min>=value?'tui-disabled':'']" @click="reduce" :style="{color:iconColor,fontSize:iconSize+'rpx'}"></view>
		<view type="number" class="tui-num-input" :style="{color:color,fontSize:size+'rpx',background:bgcolor,width:width+'rpx'}" >{{inputValue}}</view>
		...
		<view class="tui-numbox-icon tui-icon-plus" :class="[disabled || value>=max?'tui-disabled':'']" @click="plus" :style="{color:iconColor,fontSize:iconSize+'rpx'}"></view>
	</view>
</template>
