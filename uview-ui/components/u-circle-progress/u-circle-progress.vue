...
export default {
	...
	methods: {
		...
		drawCircleByProgress(progress) {
			...
			var lineG = ctx.createLinearGradient(0,0, 100,100);
			    //设置渐变行为  参数描述： 颜色的偏移量 0-1， ；颜色的色值
			    lineG.addColorStop(0,'#4CB6E7');
				lineG.addColorStop(0.5,'#88B6F4');
			    lineG.addColorStop(1,'#9397F2')
				ctx.strokeStyle = lineG;
			// ctx.setStrokeStyle(lineG);
